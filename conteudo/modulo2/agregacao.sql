...
-- STDDEV Retorna o desvio padr�o estat�stico de todos os valores da express�o especificada
...
-- script 148
-- STDDEV_POP Retorna o desvio padrao estatistico para a populaçao de todos os 
-- valores na expressao especificada
...
-- VAR_POP Retorna a variancia estatistica de todos os valores da expressao especificada
...
-- SUM	Retorna a soma de todos os valores ou somente os valores DISTINCT na express�o. SUM pode ser usado exclusivamente com colunas num�ricas.Valores nulos s�o ignorados
SELECT a.DEPARTMENT_ID "Departmento",
SUM(a.SALARY) "Soma Salarios"
FROM hr.EMPLOYEES a
GROUP BY a.DEPARTMENT_ID;

--sum com restri��o having
...
ORDER BY a.MANAGER_ID;
-- STDDEV	Retorna o desvio padr�o estat�stico de todos os valores da express�o especificada
-- VARIANCE	Determina a vari�ncia de n, ignorando valores nulos.
