...
U  Upper case
L  Lower case
A  Alfanumerico (Alphanumeric)
X  Alfanumerico com caracteres upper case (Alphanumeric with upper case alphabets)
P  Somente caracteres imprimiveis (printable characters only)
Outros caracteres: retorno sera somente em upper case (Providing any other character will return the output in upper case only)
*/
...
--MOD Devolve o resto da divisao de valor1 por valor2.]
