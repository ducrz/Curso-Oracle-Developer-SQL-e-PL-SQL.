-- Sequencia exemplo 1
--A clausula indica que os dados devem ser excluidos no final da transacao ou no final da sessao.
...
-- sequencia exemplo 2
--A clausula indica que as linhas devem persistir alem do final da transacao.
-- Eles serao removidos apenas no final da sessao.
CREATE GLOBAL TEMPORARY TABLE minha_temp (
  id           NUMBER,
  nome  VARCHAR2(20)
)
