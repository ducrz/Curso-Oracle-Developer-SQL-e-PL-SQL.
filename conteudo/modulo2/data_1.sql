...
-- Formatando datas
-- MM = Retorna o numero representando o mes. Ex: 04
select to_char(sysdate, 'MM') as campo from dual;
-- MON = Retorna a abreviacao do mes, por exemplo -ABR-
select to_char(sysdate, 'MON') as campo from dual;
-- MONTH = Retorna o nome completo do mes, por exemplo: -ABRIL-
select to_char(sysdate, 'MONTH') as campo from dual;
-- DD = retorna o dia da data informada como parametro Ex.: 07
select to_char(sysdate, 'DD') as campo from dual;
-- DY = retorna a abreviacao do dia da semana. Exemplo: SEG
select to_char(sysdate, 'DY') as campo from dual;
-- YYYY = retorna o ano com 4 digitos. Exemplo: 2014
select to_char(sysdate, 'YYYY') from dual;
-- YY = retorna os ultimos dois numeros do ano. Exemplo: 14
