...
SELECT TO_DATE(SYSDATE)-TO_DATE('2021-01-01') DIF_DIAS FROM DUAL;
...
SELECT TRUNC((MONTHS_BETWEEN(SYSDATE, TO_DATE('03/07/1989','dd/mm/yyyy')))/12) AS idade FROM DUAL;

SELECT TRUNC((MONTHS_BETWEEN(SYSDATE, TO_DATE('03/07/1989','dd/mm/yyyy')))) AS idade_MESES FROM DUAL

--DIAS DE VIDA

SELECT SYSDATE-TO_DATE('03/07/1989','dd/mm/yyyy') FROM DUAL;

--DIAS DE VIDA
SELECT TRUNC(SYSDATE-TO_DATE('03/07/1989','dd/mm/yyyy')) DIAS FROM DUAL;
