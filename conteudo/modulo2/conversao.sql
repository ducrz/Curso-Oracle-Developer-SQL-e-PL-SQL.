...
--   A funcao TO_DATE() converte de cadeia de caracteres em data. e data resultante adicionamos um dia;
--  A data obtida pelo comando anterior e apresentada usando o formato definido pelo comando ALTER SESSION SET NLS_DATE_FORMAT;


--TO_DATE(string, mascara de data)
--alterar sessao
...
--
-- TO_CHAR(data)
--TO_CHAR(data, mascara_data, [nls_date_format] )
...
SELECT  to_char(SYSDATE,'day, dd "de" Month "de" YYYY')Data_extenso FROM DUAL
--to_char
...
select 
  ...
  to_char(to_date('2018-07-17 14:15:45','yyyy-mm-dd hh24:mi:ss'), 'scc'     ) "Seculo",
